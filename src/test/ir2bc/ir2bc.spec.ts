...
describe('IR to Bytecode translator', () => {
    ...
    it('IntegerConstant', () => {
        ...
        assert.equal(ir2bc.Opcode.CONST, buffer.readUInt8(0));
    ...
    it('Add', () => {
        ...
        assert.equal(ir2bc.Opcode.CONST, buffer.readUInt8(0));
        assert.equal(1, buffer.readInt32BE(1));
        assert.equal(ir2bc.Opcode.CONST, buffer.readUInt8(5));
        assert.equal(2, buffer.readInt32BE(6));
        assert.equal(ir2bc.Opcode.ADD, buffer.readUInt8(10));
    });
    ...
    it('Sub', () => {
        ...
        assert.equal(ir2bc.Opcode.CONST, buffer.readUInt8(5));
        assert.equal(2, buffer.readInt32BE(6));
        assert.equal(ir2bc.Opcode.SUB, buffer.readUInt8(10));
    });
    ...
    it('Func', () => {
        ...
        assert.equal(2, buffer.readInt32BE(6));
        assert.equal(ir2bc.Opcode.ADD, buffer.readUInt8(10));
        assert.equal(buffer.readUInt8(11), ir2bc.Opcode.CONST);
        assert.equal(buffer.readInt32BE(12), 1);
        assert.equal(buffer.readUInt8(16), ir2bc.Opcode.RET);
    });
    ...
    it('Return', () => {
        ...
        var buffer = irTranslator.toBuffer();
        assert.equal(buffer.readUInt8(0), ir2bc.Opcode.CONST);
        assert.equal(buffer.readInt32BE(1), 1);
        assert.equal(buffer.readUInt8(5), ir2bc.Opcode.RET);
    });
