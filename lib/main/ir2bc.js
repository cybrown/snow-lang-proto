...
(function (Opcode) {
    ...
    Opcode[Opcode["RET32"] = 6] = "RET32";
    Opcode[Opcode["RET"] = 7] = "RET";
    Opcode[Opcode["CALL"] = 8] = "CALL";
    Opcode[Opcode["JP"] = 9] = "JP";
    Opcode[Opcode["JPZ"] = 10] = "JPZ";
    Opcode[Opcode["LOAD_ARG32"] = 11] = "LOAD_ARG32";
...
var Assembler = (function () {
    ...
    Assembler.prototype.add32 = function () {
        return this.op(3 /* ADD32 */);
    };
    Assembler.prototype.sub32 = function () {
        return this.op(4 /* SUB32 */);
    };
    Assembler.prototype.mul32 = function () {
        return this.op(5 /* MUL32 */);
    };
    Assembler.prototype.jp = function (address) {
        return this.op(9 /* JP */).address(address);
    };
    Assembler.prototype.jpz = function (address) {
        return this.op(10 /* JPZ */).address(address);
    };
    Assembler.prototype.call = function (address, argc) {
        return this.op(8 /* CALL */).address(address).i32(argc);
    };
    Assembler.prototype.halt = function () {
        return this.op(1 /* HALT */);
    };
    Assembler.prototype.ret32 = function () {
        return this.op(6 /* RET32 */);
    };
    Assembler.prototype.ret = function () {
        return this.op(7 /* RET */);
    };
    Assembler.prototype.load_arg32 = function (num) {
        return this.op(11 /* LOAD_ARG32 */).i32(num);
    };
...
var IrTranslator = (function () {
    ...
    IrTranslator.prototype.translateReturn = function (node) {
        ...
        this.irStreamWritter.appendOpcode(6 /* RET32 */);
    };
    ...
    IrTranslator.prototype.translateCall = function (node) {
        ...
        this.irStreamWritter.appendOpcode(8 /* CALL */);
    };
    return IrTranslator;
})();
