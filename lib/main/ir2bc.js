...
(function (Opcode) {
    ...
    Opcode[Opcode["RETVOID"] = 6] = "RETVOID";
    Opcode[Opcode["CALL"] = 7] = "CALL";
    Opcode[Opcode["JP"] = 8] = "JP";
    Opcode[Opcode["JPZ"] = 9] = "JPZ";
    Opcode[Opcode["MUL"] = 10] = "MUL";
    Opcode[Opcode["LOAD_ARG"] = 11] = "LOAD_ARG";
...
var Assembler = (function () {
    ...
    Assembler.prototype.sub = function () {
        return this.op(3 /* SUB */);
    };
    Assembler.prototype.mul = function () {
        return this.op(10 /* MUL */);
    };
    Assembler.prototype.jp = function (address) {
        return this.op(8 /* JP */).address(address);
    };
    Assembler.prototype.jpz = function (address) {
        return this.op(9 /* JPZ */).address(address);
    };
    Assembler.prototype.call = function (address, argc) {
        return this.op(7 /* CALL */).address(address).i32(argc);
    };
    ...
    Assembler.prototype.retvoid = function () {
        return this.op(6 /* RETVOID */);
    };
    Assembler.prototype.load_arg = function (num) {
        return this.op(11 /* LOAD_ARG */).i32(num);
    };
...
var IrTranslator = (function () {
    ...
    IrTranslator.prototype.translateCall = function (node) {
        ...
        this.irStreamWritter.writeOpcode(7 /* CALL */);
    };
    return IrTranslator;
})();
