...
var Assembler = (function () {
    ...
    Assembler.prototype.store32 = function (offset) {
        return this.op(21 /* STORE32 */).i32(offset);
    };
    Assembler.prototype.load_local32 = function (offset) {
        return this.op(22 /* LOAD_LOCAL32 */).i32(offset);
    };
    ...
    Assembler.prototype.jr = function (address) {
        return this.op(16 /* JR */).address(address, true);
    };
    Assembler.prototype.jrz = function (address) {
        return this.op(17 /* JRZ */).address(address, true);
    };
    Assembler.prototype.jrnz = function (address) {
        return this.op(18 /* JRNZ */).address(address, true);
    };
    ...
    Object.defineProperty(Assembler.prototype, "alloc32", {
        get: function () {
            return this.op(20 /* PUSH32_0 */);
        },
        enumerable: true,
        configurable: true
    });
    Assembler.prototype.load_arg32 = function (num) {
        return this.op(19 /* LOAD_ARG32 */).i32(num);
    };
