...
(function (Opcode) {
    ...
    Opcode[Opcode["LOAD_ARG32"] = 15] = "LOAD_ARG32";
    Opcode[Opcode["PUSH32_0"] = 16] = "PUSH32_0";
    Opcode[Opcode["STORE32"] = 17] = "STORE32";
    Opcode[Opcode["LOAD_LOCAL32"] = 18] = "LOAD_LOCAL32";
    Opcode[Opcode["AND32"] = 19] = "AND32";
    Opcode[Opcode["OR32"] = 20] = "OR32";
    Opcode[Opcode["XOR32"] = 21] = "XOR32";
    Opcode[Opcode["SHL32"] = 22] = "SHL32";
    Opcode[Opcode["SHR32"] = 23] = "SHR32";
    Opcode[Opcode["SHR32U"] = 24] = "SHR32U";
    Opcode[Opcode["EQ32"] = 25] = "EQ32";
    Opcode[Opcode["NE32"] = 26] = "NE32";
    Opcode[Opcode["GT32"] = 27] = "GT32";
    Opcode[Opcode["GT32U"] = 28] = "GT32U";
    Opcode[Opcode["GE32"] = 29] = "GE32";
    Opcode[Opcode["GE32U"] = 30] = "GE32U";
    Opcode[Opcode["NOT32"] = 31] = "NOT32";
    Opcode[Opcode["BNOT32"] = 32] = "BNOT32";
    Opcode[Opcode["NEG32"] = 33] = "NEG32";
...
var Assembler = (function () {
    ...
    Assembler.prototype.store32 = function (offset) {
        return this.op(17 /* STORE32 */).i32(offset);
    };
    Assembler.prototype.load_local32 = function (offset) {
        return this.op(18 /* LOAD_LOCAL32 */).i32(offset);
    };
    ...
    Object.defineProperty(Assembler.prototype, "alloc32", {
        get: function () {
            return this.op(16 /* PUSH32_0 */);
        },
        enumerable: true,
        configurable: true
    });
    Assembler.prototype.load_arg32 = function (num) {
        return this.op(15 /* LOAD_ARG32 */).i32(num);
    };
