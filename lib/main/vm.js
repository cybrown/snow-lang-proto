...
var CPU = (function () {
    ...
    CPU.prototype.pop32 = function () {
        return this.memory.get32(this.sp--);
    };
    CPU.prototype.pop32u = function () {
        return this.memory.get32u(this.sp--);
    };
    CPU.prototype.push32 = function (value) {
        this.memory.set32(++this.sp, value);
    };
    ...
    CPU.prototype.logStack = function () {
        ...
        console.log(offsets.map(function (offset) { return _this.memory.get32(offset); }));
    };
    //endregion
    ...
    CPU.prototype.runLoadLocal32 = function () {
        ...
        this.push32(this.memory.get32(this.fp + offset));
    };
    ...
    CPU.prototype.runStore32 = function () {
        ...
        this.memory.set32(this.fp + offset, this.pop32());
    };
    ...
    CPU.prototype.runLoadArg32 = function () {
        ...
        this.push32(this.memory.get32(this.fp - offset - 3));
    };
    return CPU;
})();
exports.CPU = CPU;
