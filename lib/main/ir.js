...
var Func = (function (_super) {
    ...
    function Func(_module, _blocks, _type, _name, _argsName) {
        if (_name === void 0) { _name = null; }
        if (_argsName === void 0) { _argsName = null; }
        _super.call(this);
        this._module = _module;
        this._blocks = _blocks;
        this._type = _type;
        this._name = _name;
        this._argsName = _argsName;
    }
    ...
    Object.defineProperty(Func.prototype, "argsName", {
        get: function () {
            return this._argsName;
        },
        enumerable: true,
        configurable: true
    });
...
var ConditionalJump = (function (_super) {
    ...
    function ConditionalJump(_condition, _destinationTrue, _destinationFalse) {
        _super.call(this);
        this._condition = _condition;
        this._destinationTrue = _destinationTrue;
        this._destinationFalse = _destinationFalse;
    }
    Object.defineProperty(ConditionalJump.prototype, "condition", {
        get: function () {
...
var ValueIrNode = (function (_super) {
    ...
    Object.defineProperty(ValueIrNode.prototype, "type", {
        get: function () {
            return this._type;
        },
        set: function (value) {
