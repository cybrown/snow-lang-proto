...
describe('CPU', function () {
    ...
    it('fact', function () {
        var bc = assembler.const_i32(5).const_p('fact').call(1).halt.label('fact').load_arg32(0).const_i32(1).sub32.jpz('isZero').load_arg32(0).load_arg32(0).const_i32(1).sub32.const_p('fact').call(1).mul32.ret32.label('isZero').const_i32(1).ret32.get();
        cpu.run(bc);
    ...
    it('sum', function () {
        var bc = assembler.alloc32.alloc32.const_i32(0).store32(0).const_i32(0).store32(1).label('begin').load_local32(1).const_i32(11).sub32.jpz('end').load_local32(0).load_local32(1).add32.store32(0).load_local32(1).const_i32(1).add32.store32(1).jp('begin').label('end').load_local32(0).halt.get();
        cpu.run(bc);
